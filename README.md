...
![GitHub License](https://img.shields.io/github/license/Lygaen/lua.zig?style=for-the-badge)
...
```sh
zig fetch --save=lua.zig https://github.com/Lygaen/lua.zig
```
...
And voilà ! You can start coding !
